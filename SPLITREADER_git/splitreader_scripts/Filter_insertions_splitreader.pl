...
my $filtname = $ARGV[7]; # filtname
my @all_pops = @ARGV[8..$#ARGV]; # list of all the genomes analysed in the cohort 
...
open OUT, ">$out_dir/$fam.$subsetname-insertions.$filtname.DP$depth.bed" ;
